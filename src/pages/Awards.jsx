...
const Awards = () => {
  return (
    <div className="pt-20 px-4 md:px-10 h-screen flex flex-col justify-center items-center text-center space-y-4">
      <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold ">TRAINING</h1>
                ...
                <HoverCardContent className="w-[500px]">
                  <ul className="list-disc text-sm text-start mx-3">
                    ...
                    <li>
                      ...
                      TypeScript application, demonstrating advanced skills and
                      achieving 95% proficiency in application development.
                    </li>
                  </ul>
                </HoverCardContent>
              </HoverCard>
              ...
              <HoverCard>
                ...
                <HoverCardContent className="w-[500px]">
                  <ul className="list-disc mx-3 text-sm">
                    <li>
                      Create a simple program that performs routing, middleware,
                      and views using Express.js and implements token-based
                    ...
                    <li>Create API documentation using swagger-ui-express.</li>
                  </ul>
                </HoverCardContent>
              </HoverCard>
            </div> */}
              ...
              <HoverCard>
                ...
                <HoverCardContent className="w-[470px]">
                  <ul className="list-disc text-sm text-start mx-3">
                    ...
                    <li>Keamanan IT: Pertahanan terhadap Kejahatan Digital</li>
                  </ul>
                </HoverCardContent>
              </HoverCard>
            </div> */}
